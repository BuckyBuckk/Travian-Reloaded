<template>
    <div class="container">
        <div class="justify-content-center text-center">
            ...
            <h6 class="my-4" v-if="resourceInfoLookup">{{resourceInfoLookup.woodcutterRequirements.description}}</h6>
            <h5>
                <div v-if="resourceInfoLookup">Current production:        {{resourceInfoLookup.woodcutterRequirements.production[resFieldLevel]}} per hour</div>
            </h5>
            <h5>
                <div v-if="resourceInfoLookup">Production at Level {{ resFieldLevel+1 }}:        {{resourceInfoLookup.woodcutterRequirements.production[resFieldLevel+1]}} per hour</div>
            </h5>
            <br />
            <h4> 
